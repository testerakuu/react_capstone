// src/Components/ProfileForm/ProfileForm.js - COMPLETE CODE (Final Confirmed Version)

// Following code has been commented with appropriate comments for your reference. 
// Import necessary modules from React and other files
import React, { useEffect, useState } from "react";
import { API_URL } from "../../config"; // Assumes API_URL is defined in config
import { useNavigate } from "react-router-dom";
import './ProfileForm.css'; // CRITICAL: Import the styling for this component
...
const ProfileForm = () => {
  ...
  useEffect(() => {
    ...
    // Dependency array ensures useEffect runs when navigate changes (only once on mount for login check)
  }, [navigate]); 
    ...
    <div className="profile-container">
      {editMode ? (
        <form onSubmit={handleSubmit}>
          ...
          {/* Name field - Correctly present and editable */}
          <label>
            Name
            <input
              type="text"
